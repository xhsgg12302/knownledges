* ## Intro(Lesson)
    ...
    + ### 练习环境准备
        ...
        <details><summary>learning.sql</summary>
        ...
        /*!40000 ALTER TABLE `t_ca` DISABLE KEYS */;
        INSERT INTO `t_ca` VALUES (1,'韩梅梅','女'),(2,'李雷','男'),(3,'李明','男');
        /*!40000 ALTER TABLE `t_ca` ENABLE KEYS */;
        ...
        --
        -- Dumping data for table `t_ua`
        --

        /*!40000 ALTER TABLE `t_ua` DISABLE KEYS */;
        INSERT INTO `t_ua` VALUES (1,'john','male'),(2,'lucy','female'),(3,'lily','female'),(4,'jack','male'),(5,'rose','female');
        /*!40000 ALTER TABLE `t_ua` ENABLE KEYS */;

        --
        -- Current Database: `myemployees`
        --
        ...
        -- Dump completed on 2024-06-21 20:48:32
        ```
        </detail>
