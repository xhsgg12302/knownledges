...
* ## Example
    ...
    + ### 02-markdown语法
        ...
        **markdown引用变量**
        ...
        <br>[baidu] [我的主页]  ← 这里有两，只会显示第一个，估计识别成两个中括号的模式了（因为鼠标放上去显示链接是第二个变量值，两个中括号中间空格无效）
        <br>[baidu]
        <br>[我的主页]
        <br>[baidu]:http://www.baidu.com
        <br>[我的主页]:http://www.jianchengss.com
        <br>[image-qr-code]: https://gitee.com/jianchengss/resources/raw/master/images/weixin/mp_QR-code/Jason_pinyaxuan_8.jpg
        <br>[image-error]: https://www.baidu.com/Jason_pinyaxuan_8.jpg

    + ### 03-图片缩放

        ![](/.images/_media/home.compress.resize..jpg 'comment :size=40%')
        ![](/.images/_media/national-emblem.png 'comment :size=30%')
