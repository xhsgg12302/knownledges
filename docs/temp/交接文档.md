...
+ app
    ...
    !> [项目地址：https://gitlab.pixdaddy.com/arbuy/backend/arbuy-app.git](https://gitlab.pixdaddy.com/arbuy/backend/arbuy-app.git)
...
* 镜像打包
    ...
    详情参考[代码片段](https://gitlab.pixdaddy.com/library/eclipse-temurin/-/snippets/4)
