* DOC
    ...
    - [MYSQL](docs/doc/advance/mysql/README.md)
        ...
        + [LESSON](docs/doc/advance/mysql/lesson/)
            ...
            -  [LESSON-TWO](docs/doc/advance/mysql/lesson/02_cmd-and-system-variables.md)
            -  [LESSON-THREE](docs/doc/advance/mysql/lesson/01_recognize.md)
            -  [LESSON-FOUR](docs/doc/advance/mysql/lesson/01_recognize.md)
            -  [LESSON-FIVE](docs/doc/advance/mysql/lesson/01_recognize.md)
            -  [LESSON-SIX](docs/doc/advance/mysql/lesson/01_recognize.md)
            -  [LESSON-SEVEN](docs/doc/advance/mysql/lesson/01_recognize.md)
            -  [LESSON-EIGHT](docs/doc/advance/mysql/lesson/01_recognize.md)
